...
$consulta = $conn->prepare("
    SELECT m.*, f.Nombre as formato_nombre, f.tipo 
    FROM multimedia m 
    ...
    <main class="pt-20 px-4 max-w-7xl mx-auto">
        ...
        <section class="mt-4 mb-8">
            ...
            <div class="flex gap-2 mt-4 overflow-x-auto pb-2 scrollbar-hide">
                <button
                    class="bg-secondary text-primary px-4 py-2 rounded-lg text-xs font-bold tracking-widest uppercase flex items-center gap-2 whitespace-nowrap">
                    <span class="material-symbols-outlined text-sm" data-icon="all_inclusive">all_inclusive</span> ALL
                    ASSETS
                </button>
                <button
                    class="bg-surface-container-low text-on-surface-variant outline outline-1 outline-outline px-4 py-2 rounded-lg text-xs font-bold tracking-widest uppercase flex items-center gap-2 whitespace-nowrap">
