                    ...
                    <div
                        ...
                        <div class="px-3 py-1 flex flex-col flex-1">
                            ...
                            <a class="mt-auto block w-full"
                                href="https://wa.me/5491169794003?text=<?php echo urlencode('Hola, me gustaría solicitar un presupuesto del producto: ' . $producto['nombre'] . ' - ' . $producto['id_producto'] . "\n\nVer producto: " . (defined('BASE_URL') ? BASE_URL : 'http://localhost/muebles-gaston') . '/public/catalogo/producto.php?id=' . $producto['id_producto']); ?>"
                                target="_blank">
                                <button
