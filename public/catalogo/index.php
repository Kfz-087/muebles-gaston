...
<body class="bg-background-light dark:bg-background-dark text-[#1c190d] dark:text-white antialiased">
    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden pb-24">
        ...
        <div id="filter-overlay" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] hidden transition-opacity">
        </div>
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            ...
                            foreach ($colores as $name => $hex):
                                ...
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <div class="w-5 h-5 rounded-full border border-gray-300 peer-checked:ring-2 peer-checked:ring-primary transition-all"
                                        style="background-color: <?php echo $hex; ?>"></div>
                                    <span
                                        class="text-sm peer-checked:font-bold group-hover:text-primary transition-colors"><?php echo $name; ?></span>
                                </label>
                            <?php endforeach; ?>
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <input type="radio" name="color" value="" class="hidden peer" <?php echo !isset($_GET['color']) || $_GET['color'] == '' ? 'checked' : ''; ?>>
                                <div
                                    class="w-5 h-5 rounded-full border border-gray-300 bg-gray-100 peer-checked:ring-2 peer-checked:ring-primary flex items-center justify-center">
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.instagram.com/gaston.rostro?igsh=MWNhc2F5eWVkNTVrMQ==" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                            <g fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                <path stroke-dasharray="66" d="M16 3c2.76 0 5 2.24 5 5v8c0 2.76 -2.24 5 -5 5h-8c-2.76 0 -5 -2.24 -5 -5v-8c0 -2.76 2.24 -5 5 -5h4Z">
                                ...
                                <path stroke-dasharray="28" stroke-dashoffset="28" d="M12 8c2.21 0 4 1.79 4 4c0 2.21 -1.79 4 -4 4c-2.21 0 -4 -1.79 -4 -4c0 -2.21 1.79 -4 4 -4">
                                    <animate fill="freeze" attributeName="stroke-dashoffset" begin="0.7s" dur="0.6s" to="0" />
                                </path>
                            </g>
                    ...
                    <a href="https://wa.me/5491169794003" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 258">
                            <defs>
                                <linearGradient id="IconifyId19d1baf1ee84ece6714" x1="50%" x2="50%" y1="100%" y2="0%">
                                    <stop offset="0%" stop-color="#1FAF38" />
                                    <stop offset="100%" stop-color="#60D669" />
                                </linearGradient>
                                <linearGradient id="IconifyId19d1baf1ee84ece6715" x1="50%" x2="50%" y1="100%" y2="0%">
                    ...
                    <a href="mailto:gastonrostro46@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                            <path fill="#ffffff" d="M20 18h-2V9.25L12 13L6 9.25V18H4V6h1.2l6.8 4.25L18.8 6H20m0-2H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2" />
                        </svg>
                        <p> Gmail</p>
                    </a>
                </div>
                ...
                <div class="payment-links">
                    <a href="#">
                        <div class="flex gap-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 199">
                                <path
    ...
    <script>
        ...
        if (searchInput && productsGrid) {
            searchInput.addEventListener('input', function () {
                ...
                if (term.length >= 0) {
                    fetch(`backend/search.php?term=${encodeURIComponent(term)}`)
