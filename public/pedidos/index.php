...
$sql = "
    ...
    LEFT JOIN clientes ON p.id_cliente = clientes.id_cliente
...
$total_pedidos = $resultados[0]['total_pedidos'];
...
<body>
    <div style="display: flex; flex-direction: column; min-height: 100vh;">
        ...
        <main style="flex: 1;">
            ...
            <section class="search-section">
                <div class="search-container">
                    ...
                    <input class="search-input" placeholder="Buscar por ID o fecha..." value="" />
                </div>
            </section>
            ...
            <section class="filter-section">
                ...
                $categories = ['Todos', 'en_preparacion', 'en_camino', 'entregado'];
        ...
        <nav class="bottom-nav">
            <a href="/distribuidora-frami/public/index.php" class="nav-item">
            ...
            <a href="/distribuidora-frami/public/pedidos/index.php" class="nav-item active">
                <span class="app-icon" style="font-variation-settings: 'FILL' 1;">receipt_long</span>
                <span class="nav-label">Pedidos</span>
            </a>
            <a href="/distribuidora-frami/public/perfil/index.php" class="nav-item">
